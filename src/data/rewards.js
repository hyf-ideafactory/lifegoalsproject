export const REWARDS = [
    ...
    //Everyday experiences (low cost/effort)
    ...
    // Big moments
    { label: "Day trip / mini adventure 🚗", weight: 2},
    { label: "Weekend getaway 🏖️", weight: 1},
    { label: "Spa day or massage 💆🏽‍♀️(with the +1 of your choosing)", weight: 1},
    { label: "$250 Dream Boost 💎", weight: 1},
